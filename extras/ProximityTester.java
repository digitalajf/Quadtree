 ...
 * quadtree.&nbsp;There's a number of UI elements to allow testing various
...
public class ProximityTester extends JPanel {
   ...
   /** *****************************************************************************
    * Set up the width and height of this drawing canvas as well as the location
    * of its top left corner so that the drawing canvas will be centered on the
    * screen.&nbsp;A menu bar with some functionality to test the Quadtree will be
    * made here and the frame will be built around both the canvas and the menu
    * bar.&nbsp;We will set up an array of "AABB" objects to test the Quadtree's
    * behavior with respect to these AABBs.&nbsp;A maximum tree depth for the
    * Quadtree,number of AABBs on screen, the game loop speed (and refresh rate)
    * are also configurable here.
    ***************************************************************************** */
   public ProximityTester() {
      ...
      /////////////////////////////////////////////////////////////////////////////
      // create a general mouse listener                                         //
      /////////////////////////////////////////////////////////////////////////////
   ...
   /** *****************************************************************************
    * Return this monitor's graphics configuration to be used with the frame.
    ***************************************************************************** */
   ...
   /** ****************************************************************************
    * Paint the Quadtree by telling each node within its hierarchy to paint itself
   ...
   /**
    * *****************************************************************************
    * Update the information in the title of the frame based on the current state
    * of the Quadtree and AABBs.
    ***************************************************************************** */
    ...
    * update the square's locations, update the Quadtree and refresh the screen by
    * calling "repaint()".&nbsp;All of this is done roughly 60 times per second.
    ***************************************************************************** */
    ...
    * wdth and hght.&nbsp;If the AABB is moving outof bounds, reverse dx or dy as
